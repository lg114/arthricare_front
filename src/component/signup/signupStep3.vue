    ...
    <el-container class = "container">
        ...
        <el-main class = "main">
            ...
            <div class = "form">
                ...
                <var-input class = "input" variant="outlined" id = "weight" type="text" v-model="tempFormData.weight" placeholder="Weight" style = "margin-bottom: 10px;" 
                :rules="[
                ...
                <var-radio-group v-model = "tempFormData.weightUnit" style = "margin-bottom: 10px;">
                    <var-radio :checked-value="'kg'">
                        <span :style="{ color: tempFormData.weightUnit === 'kg' ? '#F27B42' : '#006973' }"><b>Kg</b></span>
                    </var-radio>
                    <var-radio :checked-value="'lbs'">
                        <span :style="{ color: tempFormData.weightUnit === 'lbs' ? '#F27B42' : '#006973' }"><b>Lbs</b></span>
                    </var-radio>
                </var-radio-group>
    ...
    export default {
        ...
        methods:{
            updateData(){
                this.$emit('updateFormData',{
                    weight: this.tempFormData.weight,
                    weightUnit:this.tempFormData.weightUnit
                });
        ...
        watch:{
            formData:{
                deep: true,
                handler(newValue) {
                    this.tempFormData.weight = newValue.weight;
                    this.tempFormData.weightUnit = newValue.weightUnit;
                },
            }
        }
    }
