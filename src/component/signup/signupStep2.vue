    ...
    <el-container class = "container">
        ...
        <el-main class = "main">
            ...
            <div class = "form">
                ...
                <var-input class = "input" variant="outlined" id = "age" type="text" v-model="tempFormData.age" placeholder="Age" style = "margin-bottom: 20px;" 
                :rules="[
                    (v) => !isNaN(parseFloat(v)) && isFinite(v) || 'Please enter a valid number',
                    (v) => v > 0 || 'Value must be greater than 0',
                    (v) => v.length <= 3 || 'Length cannot be greater than 3'
                ]"/>
    ...
    export default {
        ...
        watch:{
            formData:{
                deep: true,
                handler(newValue) {
                    this.tempFormData.age = newValue.age;
                },
            }
        }
    }
