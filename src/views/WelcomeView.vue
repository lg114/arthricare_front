      ...
      <el-footer>
        <div class = "buttons">
          ...
          <router-link to = "/Education">
            <el-button class = "signup-button">Education</el-button>
          </router-link>
          <router-link to = "/Assessment">
            <el-button class = "signup-button">Ass</el-button>
          </router-link>
          <router-link to = "/MyMedtest">
            <el-button class = "signup-button">MyMedtest</el-button>
          </router-link>
        </div>        
      </el-footer>
    </el-container>
